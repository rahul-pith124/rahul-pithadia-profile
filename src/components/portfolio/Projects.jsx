...
const Projects = ({ data }) => {
  return (
    <div className="max-w-106 rounded-lg outline-[#FFFFFF] bg-[#fff] hover:shadow-2xl duration-300 transition-all shadow-gray-300 border border-gray-200">
      <div className="border " style={{height:"250px",}}>

      <img src={data?.image} style={{height:"100%"}} alt={`${data?.title} image`} />
      </div>

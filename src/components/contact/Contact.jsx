...
const addressData = [
  {
    icon: faLinkedin,
    title: "LinkedIn",
    description: "www.linkedin.com/in/rahul-pithadia/",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "rahulpith1331@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
      ...
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            ...
            <div className="my-8.75 sm:max-lg:flex flex-wrap justify-between items-center">
